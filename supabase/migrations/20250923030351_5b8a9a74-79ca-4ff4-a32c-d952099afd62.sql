-- Add investment transaction type to existing transactions table
ALTER TYPE transaction_type ADD VALUE IF NOT EXISTS 'investment';

-- Add investment pocket type to budget_pockets table  
ALTER TYPE pocket_type ADD VALUE IF NOT EXISTS 'investment';
